...
class ExtractContour:
    def __init__(self,img):
        ...
        pruple_mask = cv2.inRange(hsv,(160, 100, 100), (180, 150,250))
        # cv2.imshow('purple mask', pruple_mask)
        # cv2.waitKey()
...
if __name__ == '__main__':
   ...
   # region image processing
    ...
    # img = size_mod(img_aligned_plus, 0.5)
    # endregion


    cv2.imshow('img',size_mod(img_aligned_plus,0.5))
    cv2.waitKey()
    BF = BotFinder()
